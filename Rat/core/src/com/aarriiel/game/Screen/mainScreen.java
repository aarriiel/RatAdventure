...
public class mainScreen implements Screen {
    //define whether have been played
    ...
    public mainScreen(RatAdventure game){
        this.game = game;
        camera=new OrthographicCamera();
        gamePort=new FitViewport(RatAdventure.V_WIDTH,RatAdventure.V_HEIGHT,camera);
        ...
        labelName = new String[]{"New Game","Load game","Setting","End"};
    ...
    public void select() {
        switch (currentItem) {
            case 0:
                game.setScreen(new storyScreen(game,"BeginDialog"));
                break;
            case 1:
                break;
            case 2:
